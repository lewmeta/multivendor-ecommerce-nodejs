        ...
        <div className="sm:p-8 p-4 w-full h-full">
          <form className="w-full" onSubmit={onSubmit}>
            ...
            <div className="grid gap-6">
              ...
              <input name="cpassword" type="password" className="bg-gray-100 w-full text-gray-800 text-sm px-4 py-3 rounded-md outline-blue-500" placeholder="Enter confirm password" />
            </div> */}
            </div>
            ...
            <div className="flex items-center mt-6">
              ...
              />
              <label htmlFor="checkbox" className="ml-3 block text-sm">
                I accept the{" "}
                <a
                  href="/#"
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <button
              type="button"
              className="w-full px-3 py-2.5 flex items-center justify-center rounded-md text-gray-800 text-sm tracking-wider font-normal border-none outline-none bg-gray-100 hover:bg-gray-200"
            >
              <svg
            ...
            <button
              type="button"
              className="w-full px-3 py-2.5 flex items-center justify-center rounded-md text-white text-sm tracking-wider font-semibold border-none outline-none bg-black hover:bg-[#333]"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="22px"
